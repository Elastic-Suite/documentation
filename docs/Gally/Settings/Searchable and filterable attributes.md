...
|Use in rule engine|No|Is the attribute used in rule engine in Gally admin or not. Meaning : I attribute and its values will be used as conditions in rule engines. If set to yes, attribute is available in every rule engine of Gally admin (virtual category, boosts...)|
